  ...
  const [c1] = await CourseModel.insertMany([
    {
      ...
      isPublished: true,
      totalLessons: 6,
      instructorName: "IELTS Expert Team",
      isActive: true,
    },
  ]);
  ...
  const [q1, q2, q3] = await ExamQuestionModel.insertMany([
    {
      ...
      isPublished: true,
      attemptCount: 0,
      tags: ["environment", "recycling", "agree-disagree", "government-policy"],
    },
    {
      ...
      isPublished: true,
      attemptCount: 0,
      tags: ["environment", "plastic-pollution", "problem-solution", "ocean"],
    },
    {
      ...
      isPublished: true,
      attemptCount: 0,
      tags: ["environment", "biodiversity", "climate-change", "discuss-both-views"],
    },
  ]);
