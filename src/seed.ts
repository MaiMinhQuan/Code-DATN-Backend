  ...
  const [c1] = await CourseModel.insertMany([
    {
      ...
      description: "Khóa học giúp bạn chinh phục chủ đề Môi trường và Phát triển Bền vững trong IELTS Writing Task 2. Sáu bài học được tổ chức thành ba cấp độ: Band 5.0 tập trung vào Opinion Essay và Paraphrase; Band 6.0 đi sâu vào Process Description và Problem-Solution; Band 7.0+ rèn luyện Discursive Essay và lập luận học thuật nâng cao. Từ vựng và ngữ pháp được trích xuất trực tiếp từ các video của Vox, National Geographic, Kurzgesagt và TED, kèm mốc thời gian để bạn nghe lại ngữ cảnh thực tế.",
      topicId: topicInfo,
      isPublished: true,
      totalLessons: 0,
      isActive: true,
...
> *"Some people believe that the government should ban deforestation completely."*`,
    ...
    // ── L3 — Band 6.0 — Fossils 101 / National Geographic ───────────────────
    {
      ...
      vocabularies: [
        ...
        { word: "resin", pronunciation: "/ˈrezɪn/", definition: "A sticky substance secreted by trees that can entrap organisms and eventually harden into amber", translation: "nhựa cây", examples: ["When an insect lands on tree resin, it can become permanently entrapped as the resin hardens around it.", "The chemical properties of tree resin create an oxygen-free environment that prevents the decay of entrapped organisms."], timestamp: 93, contextSentence: "The sap or resin forms a protective seal around the entrapped organism." },
        ...
        { word: "carbonization", pronunciation: "/ˌkɑːbənaɪˈzeɪʃn/", definition: "A fossilization process in which organic material is compressed until only a thin film of carbon remains", translation: "quá trình carbon hóa (than hóa)", examples: ["Carbonization is the process by which compressed plant material formed the coal deposits that now fuel the world's power stations.", "Fern fossils preserved by carbonization often retain such detail that individual cell walls remain visible under a microscope."], timestamp: 125, contextSentence: "carbonization transforms soft tissues into thin black films of carbon." },
        { word: "permineralization", pronunciation: "/ˌpɜːmɪnərəlaɪˈzeɪʃn/", definition: "The most common fossilization process, in which minerals fill the spaces within bone or wood, turning organic tissue to stone", translation: "quá trình khoáng hóa (hóa đá)", examples: ["Permineralization preserved the dinosaur bones on display in natural history museums worldwide.", "Through permineralization, a tree trunk can be transformed into solid stone while retaining its original cellular structure."], timestamp: 145, contextSentence: "one of the most common types of fossilization that changes a specimen is called permineralization." },
...
Secondly, recycling can help to reduce waste and protect`,
  ...
  const [fs1, fs2, fs3, fs4, fs5, fs6] = await FlashcardSetModel.insertMany([
    {
      userId: u2._id,
      title: "L1: Nhựa Biến Mất — Band 5.0",
      description: "12 từ vựng từ video Vox về hành trình nhựa trong đại dương: debris, accumulate, microplastics, degrade và các từ liên quan. Nền tảng cho bài Opinion Essay về môi trường.",
    },
    {
      userId: u2._id,
      title: "L2: Rừng Amazon — Band 5.0",
      description: "12 từ vựng từ video TED-Ed về phá rừng Amazon: deforestation, tipping point, carbon sink, transpiration. Dùng trong bài về nguyên nhân và hậu quả của phá rừng.",
    },
    {
      userId: u2._id,
      title: "L3: Hóa Thạch 101 — Band 6.0",
      description: "12 từ vựng khoa học từ video National Geographic về hóa thạch: fossilization, permineralization, amber, specimen. Rèn luyện passive voice và định nghĩa học thuật.",
    },
    {
      userId: u2._id,
      title: "L4: Khủng hoảng Nhựa — Band 6.0",
      description: "12 từ vựng từ video Kurzgesagt về ô nhiễm nhựa toàn cầu: polymer, microplastics, single-use, trade-off, infrastructure. Dùng trong bài Problem-Solution.",
    },
    {
      userId: u2._id,
      title: "L5: Còn Kịp Dừng Biến Đổi Khí Hậu? — Band 7.0+",
      description: "12 từ vựng từ video Kurzgesagt về biến đổi khí hậu: emissions, electrification, rebound effect, net-zero, carbon capture. Dùng trong bài Discursive Essay nâng cao.",
    },
    {
      userId: u2._id,
      title: "L6: Thỏa Thuận Paris — Band 7.0+",
      description: "12 từ vựng từ TED Talk của Christiana Figueres về Paris Agreement: unanimously, entrenched, sovereign, optimism, legally binding. Ngôn ngữ ngoại giao và hợp tác quốc tế.",
    },
  ]);
  ...
  await FlashcardModel.insertMany([
    ...
    // ── FS2 — L2 "Amazon Rainforest" (TED-Ed) — 12 thẻ ──────────────────────
    {
      setId: fs2._id,
      frontContent: "deforestation",
      backContent: "<p><strong>Nghĩa:</strong> Nạn phá rừng, chặt phá rừng quy mô lớn thường cho mục đích nông nghiệp hoặc phát triển</p><p><strong>Phát âm:</strong> /diːˌfɒrɪˈsteɪʃn/</p><p><strong>Ví dụ:</strong> <em>As of 2022, humans have deforested 17% of the Amazon and scientists warn that a tipping point may be near.</em></p><p><strong>Từ đồng nghĩa:</strong> forest clearing, forest loss, tree felling, logging, forest destruction</p>",
      reviewCount: 3,
      nextReviewDate: daysAgo(-1),
    },
    {
      ...
      backContent: "<p><strong>Nghĩa:</strong> Điểm tới hạn, ngưỡng không thể đảo ngược khi vượt qua thì hệ thống sụp đổ nhanh chóng và tự duy trì</p><p><strong>Phát âm:</strong> /ˈtɪpɪŋ pɔɪnt/</p><p><strong>Ví dụ:</strong> <em>Scientists warn that losing 25-40% of the Amazon could trigger a tipping point, transforming the forest into savanna permanently.</em></p><p><strong>Từ đồng nghĩa:</strong> critical threshold, point of no return, breaking point, turning point</p>",
      reviewCount: 3,
      nextReviewDate: daysAgo(-1),
    },
    {
      setId: fs2._id,
      frontContent: "transpiration",
      backContent: "<p><strong>Nghĩa:</strong> Sự thoát hơi nước của thực vật, quá trình cây nhả hơi nước qua lá góp phần tạo mưa và làm mát khí hậu địa phương</p><p><strong>Phát âm:</strong> /ˌtrænsˌpɪˈreɪʃn/</p><p><strong>Ví dụ:</strong> <em>Through transpiration, the Amazon cycles approximately 20 trillion litres of water daily, generating the rainfall that sustains it.</em></p><p><strong>Từ đồng nghĩa:</strong> water evaporation (from plants), plant water release, stomatal evaporation</p>",
      reviewCount: 2,
      nextReviewDate: daysAgo(0),
    },
    {
      ...
      backContent: "<p><strong>Nghĩa:</strong> Bể hấp thụ carbon, hệ thống tự nhiên như rừng hay đại dương hấp thụ CO₂ nhiều hơn lượng thải ra</p><p><strong>Phát âm:</strong> /ˈkɑːbən sɪŋk/</p><p><strong>Ví dụ:</strong> <em>The Amazon is one of the world's largest natural carbon sinks, absorbing billions of tonnes of CO₂ annually.</em></p><p><strong>Từ đồng nghĩa:</strong> CO₂ absorber, carbon store, carbon reservoir, natural carbon sequester</p>",
      reviewCount: 2,
      nextReviewDate: daysAgo(0),
    },
    {
      setId: fs2._id,
      frontContent: "habitat loss",
      backContent: "<p><strong>Nghĩa:</strong> Mất môi trường sống, sự phá hủy hoặc suy thoái môi trường tự nhiên mà các loài phụ thuộc vào để sinh tồn</p><p><strong>Phát âm:</strong> /ˈhæbɪtæt lɒs/</p><p><strong>Ví dụ:</strong> <em>Habitat loss caused by Amazon deforestation threatens 10% of all known species on Earth.</em></p><p><strong>Từ đồng nghĩa:</strong> habitat destruction, environmental degradation, ecosystem destruction</p>",
      reviewCount: 2,
      nextReviewDate: daysAgo(0),
    },
    {
      setId: fs2._id,
      frontContent: "drought",
      backContent: "<p><strong>Nghĩa:</strong> Hạn hán, thời kỳ kéo dài với lượng mưa thấp bất thường dẫn đến thiếu nước và căng thẳng hệ sinh thái</p><p><strong>Phát âm:</strong> /draʊt/</p><p><strong>Ví dụ:</strong> <em>Recent droughts in the Amazon have already triggered widespread fires and tree die-offs, foreshadowing future tipping points.</em></p><p><strong>Từ đồng nghĩa:</strong> water scarcity, arid conditions, dry spell, water shortage</p>",
      reviewCount: 2,
      nextReviewDate: daysAgo(0),
    },
    {
      setId: fs2._id,
      frontContent: "evaporation",
      backContent: "<p><strong>Nghĩa:</strong> Sự bốc hơi nước, chuyển đổi nước lỏng thành hơi nước do nhiệt năng, một bước quan trọng trong chu trình nước</p><p><strong>Phát âm:</strong> /ɪˌvæpəˈreɪʃn/</p><p><strong>Ví dụ:</strong> <em>Reduced evaporation from deforested land disrupts rainfall patterns hundreds of kilometres away from the cleared area.</em></p><p><strong>Từ đồng nghĩa:</strong> vaporization, water cycle loss, moisture release</p>",
      reviewCount: 1,
      nextReviewDate: daysAgo(1),
    },
    {
      setId: fs2._id,
      frontContent: "rainfall",
      backContent: "<p><strong>Nghĩa:</strong> Lượng mưa, tổng lượng mưa rơi xuống một khu vực trong một khoảng thời gian nhất định</p><p><strong>Phát âm:</strong> /ˈreɪnfɔːl/</p><p><strong>Ví dụ:</strong> <em>Models predict that losing 40% of the Amazon would reduce rainfall in Argentina's agricultural heartland by 25%.</em></p><p><strong>Từ đồng nghĩa:</strong> precipitation, downpour, rain, precipitation levels</p>",
      reviewCount: 1,
      nextReviewDate: daysAgo(1),
    },
    {
      ...
      backContent: "<p><strong>Nghĩa:</strong> Có khả năng phục hồi, có thể phục hồi sau gián đoạn và duy trì chức năng bình thường</p><p><strong>Phát âm:</strong> /rɪˈzɪliənt/</p><p><strong>Ví dụ:</strong> <em>So far the Amazon has remained resilient, but scientists warn this capacity has limits.</em></p><p><strong>Từ đồng nghĩa:</strong> adaptable, robust, resistant, sturdy, flexible</p>",
      reviewCount: 1,
      nextReviewDate: daysAgo(1),
    },
    {
      setId: fs2._id,
      frontContent: "sustainable",
      backContent: "<p><strong>Nghĩa:</strong> Bền vững, đáp ứng nhu cầu hiện tại mà không làm tổn hại đến khả năng của thế hệ tương lai</p><p><strong>Phát âm:</strong> /səˈsteɪnəbl/</p><p><strong>Ví dụ:</strong> <em>Practising sustainable agriculture and fire management could allow the Amazon to generate more economic value, not less.</em></p><p><strong>Từ đồng nghĩa:</strong> eco-friendly, green, renewable, long-term viable, environmentally responsible</p>",
      reviewCount: 1,
      nextReviewDate: daysAgo(1),
    },
    {
      setId: fs2._id,
      frontContent: "stewardship",
      backContent: "<p><strong>Nghĩa:</strong> Quản lý và bảo vệ có trách nhiệm, đặc biệt là việc bảo tồn tài nguyên thiên nhiên bởi những người sống trong hoặc phụ thuộc vào đó</p><p><strong>Phát âm:</strong> /ˈstjuːədʃɪp/</p><p><strong>Ví dụ:</strong> <em>Indigenous stewardship of Amazon land resulted in over 300 million metric tonnes of carbon being removed from the atmosphere.</em></p><p><strong>Từ đồng nghĩa:</strong> guardianship, conservation, management, custodianship, protection</p>",
      reviewCount: 0,
      nextReviewDate: daysAgo(2),
    },
    {
      ...
      backContent: "<p><strong>Nghĩa:</strong> Hệ sinh thái, cộng đồng sinh vật sống phức tạp tương tác với nhau và với môi trường vật lý như một hệ thống thống nhất</p><p><strong>Phát âm:</strong> /ˈiːkəʊˌsɪstəm/</p><p><strong>Ví dụ:</strong> <em>When enough of the Amazon is cleared, large swaths of the ecosystem can die, triggering a chain reaction across the entire biome.</em></p><p><strong>Từ đồng nghĩa:</strong> biome, environment, ecological community, natural system, ecological network</p>",
      reviewCount: 0,
      nextReviewDate: daysAgo(2),
    },
  ...
  console.log("🃏 Flashcard Sets + Cards created:", fs1._id, fs2._id, fs3._id, fs4._id, fs5._id, fs6._id);
